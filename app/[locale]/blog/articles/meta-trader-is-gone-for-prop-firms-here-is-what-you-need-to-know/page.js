...
const i18nNameSpaces = ["common", "blog_landing", "article_metatrader_is_gone"];

//Params to bring the info from the db
const blogParam = "meta-trader-is-gone-for-prop-firms-here-is-what-you-need-to-know"
...
const metadata_fr = {
  title: "Avenir du Trading chez les Firmes Propriétaires : Présentation de TradeLocker",
  description: "Découvrez TradeLocker par TopTier Trader - La plateforme de trading ultime conçue pour améliorer votre day trading avec des fonctionnalités avancées telles que le calculateur SL&TP, l'intégration TradingView et le trading en un clic.",
  ...
  og: {
    type: "article",
    title: "Avenir du Trading chez les Firmes Propriétaires : Présentation de TradeLocker",
    description: "Optimisez votre stratégie de trading avec les fonctionnalités de pointe de TradeLocker. Engagez-vous dans un day trading efficace, informé et rapide.",
    image: "",
    site_name: "TopTier Trader",
    ...
    >
      ...
      <div style={bgImageStyleBlog} className="flex flex-col items-center pb-20 mb:pt-5 mb:-mt-10">
        <header className="mb:mt-0 flex flex-col items-start max-w-[1100px] my-6  w-full">
          <h1 className='mb:mt-0 mb:mb-10 max-w-[1100px] my-6 px-8  mb:px-0 text-4xl text-start font-medium mb:text-5xl text-white mb:mr-5'> {t('article_metatrader_is_gone:h1_title')}  </h1>
        </header>

        <article className="bg-transparent max-w-[1100px] text-slate-300 text-base mb:text-lg mb:px-0 px-8">

          {/* User */}
          {/* <User name={'Mike Williams'} role={'Trading Expert'} date={'Jun 14 2024'} userImg={userImg} /> */}

          {t('article_metatrader_is_gone:par_one')} <br /><br />
          {t('article_metatrader_is_gone:par_two')}<br /><br />
          {t('article_metatrader_is_gone:par_three')} <br /><br />

          {t('article_metatrader_is_gone:par_four')}<br /><br />
          {t('article_metatrader_is_gone:par_five')}<br /><br />
          {t('article_metatrader_is_gone:par_six')}<br /><br />

          <h3 className="font-semibold text-2xl">{t('article_metatrader_is_gone:par_seven')}</h3><br />

          <CtaButton
            utm="https://app.toptiertrader.com/buy-challenge/?el=MetaTrader_Is_Gone_For_Prop_Firms_Blog_CTA&hcategory=July2025&htrafficsource=Website&id=cad77f17-0cb5-4e7d-8a71-644f4a3f6a17&addons=doubleLeverage&addons=tradeOnWeekends&addons=higherProfitShare&addons=maxLoss"
            page="Blog"
            section="MetaTrader is Gone for Prop Firms"

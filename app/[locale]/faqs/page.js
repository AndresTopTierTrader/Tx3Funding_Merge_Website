...
//Metadata
const metadata_en = {
  title: "TopTier Trader Help Center",
  ...
  og: {
    ...
    url: `${ENVIRONMENT_URL}/en/faqs`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/en/faqs`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',
...
const metadata_es = {
  title: "Centro de ayuda de TopTier Trader",
  ...
  og: {
    ...
    site_name: "TopTier Trader",
    url: `${ENVIRONMENT_URL}/es/faqs`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/es/faqs`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',

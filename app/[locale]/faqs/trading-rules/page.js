...
const metadata_en = {
  ...
  og: {
    ...
    url: `${ENVIRONMENT_URL}/en/trading-rules`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/en/trading-rules`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',
...
const metadata_es = {
  ...
  og: {
    ...
    site_name: "TopTier Trader",
    url: `${ENVIRONMENT_URL}/es/trading-rules`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/es/trading-rules`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',

...
const MainSectionLazyLoading = dynamic(() => import("@/components/halloween/Main"), {
  ssr: true,
...
const StepsSectionLazyLoading = dynamic(() => import("@/components/halloween/Steps"), {
  ssr: true,
  loading: () => <div className="w-full py-80 flex mb:flex-row flex-col justify-center items-center rounded-xl" style={bgImageStyle}>
    <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-200 fill-ttblue" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="currentColor" />
...
export default async function Page({ params: { locale } }) {
  ...
  const translations = {
    titleOne: t('halloween:title_one'),
    descTotaling: t('halloween:desc_totaling'),
    descOne: t('halloween:desc_one'),
    titleTwo: t('halloween:title_two'),
    descTwo: t('halloween:desc_two'),
    costumeTitle: t('halloween:costume_title'),
    costumeDesc: t('halloween:costume_desc'),
    costumeSubmission: t('halloween:costume_submission'),
    costumeAll: t('halloween:costume_all'),
    entries: t('halloween:entries'),
    costumeMultiplier: t('halloween:costume_multiplier'),
    subRequirements: t('halloween:sub_requirements'),
    costumeReqOne: t('halloween:costume_req_one'),
    costumeReqTwo: t('halloween:costume_req_two'),
    costumeReqThree: t('halloween:costume_req_three'),
    ctaFill: t('halloween:cta_fill'),
    challengeTitle: t('halloween:challenge_title'),
    challengeDesc: t('halloween:challenge_desc'),
    challengeAccount: t('halloween:challenge_account'),
    challengeReqOne: t('halloween:challenge_req_one'),
    challengeReqTwo: t('halloween:challenge_req_two'),
    challengeReqThree: t('halloween:challenge_req_three'),
    ctaBecome: t('halloween:cta_become'),
    referTitle: t('halloween:refer_title'),
    referDesc: t('halloween:refer_desc'),
    referRefferal: t('halloween:refer_refferral'),
    referDescOne: t('halloween:refer_desc_one'),
    referDescTwo: t('halloween:refer_desc_two'),
    referDescThree: t('halloween:refer_desc_three'),
    participantsTitle: t('halloween:parcitipants_title'),
    participantsDescOne: t('halloween:participants_desc_one'),
    participantsDescTwo: t('halloween:participants_desc_two'),
    participantsFully: t('halloween:participants_fully'),
    participantsFirst: t('halloween:participants_first'),
    participantsSecond: t('halloween:participants_second'),
    participantsThird: t('halloween:participants_thrid'),
  }

...
const MainSectionLazyLoading = dynamic(() => import("@/components/certificates/Main"), {
  ssr: true,
...
const i18nNameSpaces = ["common", "certificates"];
...
export default async function Page({ params: { locale } }) {
  ...
  const mainSectionTranslations = {
    h1_title_1: t('certificates:h1_title_1'),
    h1_title_2: t('certificates:h1_title_2'),
    subtitle: t('certificates:subtitle'),
    p1: t('certificates:p1'),
    input_placeholder: t('certificates:input_placeholder'),
    CTA: t('certificates:CTA'),
    p2: t('certificates:p2'),
    faqButton: t('certificates:faqButton'),
    error: t('certificates:error'),
  }

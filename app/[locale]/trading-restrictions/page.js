...
const metadata_en = {
  ...
  og: {
    ...
    url: `${ENVIRONMENT_URL}/en/help-center/trading-restrictions`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/en/help-center/trading-restrictions`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',
...
const metadata_es = {
  ...
  og: {
    ...
    site_name: "TopTier Trader",
    url: `${ENVIRONMENT_URL}/es/help-center/trading-restrictions`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/es/help-center/trading-restrictions`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',
...
const metadata_fr = {
  ...
  og: {
    ...
    // Ensure you replace 'metadataImg' with the actual image metadata
    site_name: "TopTier Trader",
    url: `${ENVIRONMENT_URL}/fr/help-center/trading-restrictions`
  },
  alternates: {
    canonical: `${ENVIRONMENT_URL}/fr/help-center/trading-restrictions`,
    languages: {
      'en': '/en',
      'es': '/es',
      'es-co': '/es-co',
...
export default async function Page({ params: { locale } }) {
  ...
  return (
    <div>
      <Proxy link={'https://intercom.help/toptiertrader/en/?q=trading+restrictions'} />
    </div>
  )
}

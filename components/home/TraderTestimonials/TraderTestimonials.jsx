...
export default function Traders() {
    ...
    const bgTraders = {
        ...
        backgroundImage: `
         radial-gradient(at 40% 20%, hsla(219,45%,7%,1) 0px, transparent 50%),
         radial-gradient(at 80% 0%, hsla(219,45%,7%,1) 0px, transparent 50%),
         radial-gradient(at 52% 70%, hsla(219,45%,7%,1) 0px, transparent 50%),
         radial-gradient(at 36% 100%, hsla(219,45%,7%,1) 0px, transparent 50%),
         radial-gradient(at 0% 60%, hsla(212,100%,35%,0.41) 0px, transparent 50%),
         radial-gradient(at 0% 41%, hsla(112,97%,65%,0.39) 0px, transparent 50%)
        `
    }
    ...
    return (
        <section
            className="flex flex-col items-center gap-8 md:gap-20 mx-auto"
            style={bgTraders}
        >
            <div className="flex flex-col items-center max-w-[1200px] py-8 ">
                ...
                <div className="flex items-center gap-6 mt-8 md:mt-12 overflow-x-scroll pb-4 w-full pl-7">
                    {videoSources.map((video, index) => (
                        <div
                            key={index}
                            className="group relative rounded-lg overflow-hidden aspect-[9/16] w-64 min-w-[256px] border border-[#717892] grid place-items-center"
                        >
                            <video
                                autoPlay
                                loop
                                muted={soundEnabledIndex !== index}
                                playsInline
                                preload="metadata"
                            ...
                            <button
                                ...
                                className="md:opacity-0 md:translate-y-6 group-hover:opacity-100 group-hover:translate-y-0 transition-all absolute top-2 right-2 cursor-pointer"
                            >
                                {soundEnabledIndex === index ? <VolumeUp /> : <VolumeDown />}
                            </button>
                        </div>
                    ))}
                </div>

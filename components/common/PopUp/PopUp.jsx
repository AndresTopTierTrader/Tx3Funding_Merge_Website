                    ...
                    >
                        ...
                        <div className='mb:mt-10'>
                            ...
                            <form onSubmit={handleSubmit} className='flex flex-col mb:flex-row items-center pb-2 mb:pb-0'>
                                ...
                                <button 
                                    type='submit' 
                                    className={`bg-ttorange w-full mb:w-1/4 px-5 text-white font-semibold rounded-2xl py-3 text-center mt-3 mb:ml-3 cursor-pointer ${!isChecked && 'opacity-50 cursor-not-allowed'} flex items-center justify-center`} 
                            ...
                            {error && <p className='bg-red-400 rounded-xl -mt-6 mb-10  py-4 px-3 text-white mb:mt-2'>{error}</p>}
                            {success && <p className='bg-green-500 text-white px-4 py-2 mb:py-4 mb-10 mb:mb-0 rounded-xl'>{success}</p>}
                        </div>
                    </motion.div>
                </motion.div>
            )}

  ...
  return (
    ...
    >
      <button
        ...
        className="relative z-10 flex items-center gap-2 px-6 py-3 text-textPrimary bg-[#0B0F1A] border border-[#4D516A] rounded-lg hover:bg-[#131927] transition-all duration-200 shadow-lg"
      >

...
const AccountAmountSelector = ({
  ...
  const selectStyles = {
    unselected:
      "bg-[#181D28] border border-[#4D516A] text-white hover:cursor-pointer hover:bg-[#131927] transition-all duration-200 rounded-lg",
    selected:
      "bg-gradient-to-b from-[#0052B4] to-[#167ACC] text-white font-semibold hover:cursor-pointer transition-all duration-200 rounded-lg",
  };

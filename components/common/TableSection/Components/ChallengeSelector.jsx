  ...
  return (
    ...
    >
        ...
        <motion.button
          ...
          className={`w-full  py-3 md:py-4 px-2 text-sm md:text-base font-medium rounded-lg transition-all duration-200 ${
            isOptionSelected(CHALLENGE_TYPES.ONE_PHASE)
              ? "bg-gradient-to-b from-[#0052B4] to-[#167ACC] h-12 md:h-14 text-white"
              : "bg-[#181D28] border border-[#4D516A] text-white h-12 md:h-14 hover:bg-[#131927]"
          }`}
      ...
      <div className="flex-1 max-w-xs relative">
        ...
        {/* Badge for Flex */}
        <div
          className={`hidden md:flex flex-row justify-center items-center bg-ttorange absolute -top-4 left-1/2 w-20 md:w-36 transform -translate-x-1/2 text-xs text-white ${
            isLATAM ? "scale-125" : ""

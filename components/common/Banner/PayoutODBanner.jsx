                ...
                >
                    ...
                    <div className="flex flex-row items-center w-full -mt-1 -ml-3 mb:hidden">
                        ...
                        <div className='flex flex-col items-start ml-4'>
                            ...
                            <p className='z-50 flex flex-row items-end -mt-1 text-xl font-medium text-textPrimary'>
                                Payout On Demand
                            </p>

                            <div className='flex flex-col items-start mt-1'>
                                <p className='z-50 flex flex-row items-end text-xs text-textPrimary -mt -1 font-regular'>
                    ...
                    <div className="items-center hidden mb:flex mb:flex-row ">
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <p className='z-50 flex flex-row items-end text-3xl font-medium text-textPrimary -mt -1'>
                                Payout On Demand
                            </p>
                        </div>
                        ...
                        <div className='flex flex-col items-start -ml-20'>
                            <p className='z-50 flex flex-row items-end text-lg text-textPrimary -mt -1 font-regular'>
                                {mainLang == 'es' ? "Solicita tu Payout" : "Request Your Payout"}
                            </p>
                        ...
                        <div className='flex flex-col items-center ml-16 '>
                            ...
                            <div className='px-5 py-2 rounded-lg bg-ttorange '>
                                <p className='text-base text-textPrimary text-semibold'>{mainLang == 'es' ? "FONDÉATE AHORA" : "GET FUNDED NOW"} </p>
                            </div>
                            <p className='z-50 flex flex-row items-end mt-1 text-xs italic text-textPrimary font-regular'>

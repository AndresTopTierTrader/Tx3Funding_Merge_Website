...
export function VideoSlider({ translations }) {
    ...
    return (
        <section className="bg-[#0B111D]">
            <div className="mx-auto max-w-[1600px] px-7 py-12 md:py-20 text-white">
                <span>
                    <h2 className="text-white text-3xl md:text-5xl font-semibold text-center mx-auto">{translations.t5}</h2>
                    <p className="text-[#717892] text-center mt-5">{translations.p7}</p>
                </span>

                <div className='flex items-center gap-6 mt-10 md:mt-20 overflow-x-auto pb-4'>
                    {

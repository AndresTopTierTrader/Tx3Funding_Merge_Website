...
function QuizHeroSection({ translations, locale }) {
  ...
  return (
    <div className="relative flex flex-col px-6 sm:px-0 items-center max-w-[600px] mt-8 sm:mt-12">
      {/* Discount Badge */}
      <div className="absolute -top-8 right-0 sm:-top-8 sm:right-10 bg-[#FF532D] text-textPrimary text-[9px] sm:text-[11px] font-bold w-16 h-16 sm:w-20 sm:h-20 rounded-full transform rotate-12 shadow-lg flex items-center justify-center z-10">
      ...
      <h1
        className="text-center text-4xl sm:text-6xl font-normal text-textPrimary leading-tight"
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-8 items-center justify-center w-full mx-auto">
        <div className="transition-all hover:scale-105 w-[180px] flex justify-center mx-auto sm:mx-0">
          <button
            ...
            className="flex flex-row items-center text-sm rounded-lg bg-transparent border-2 border-white/30 hover:border-white/50 text-textPrimary transition-all py-2 px-4 scaleIn w-full justify-center"
          >

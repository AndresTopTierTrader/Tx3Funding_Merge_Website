...
function SecondQuestion({ setCurrentStep, setAnswers, translations }) {
    ...
    const options = [
        { id: 'oneToThreeMonths', label: q1, value: 'Short' },
        { id: 'threeToTwelveMonths', label: q2, value: 'Short' },
        { id: 'oneToThreeYears', label: q3, value: 'Long' },
        { id: 'threeToFiveYears', label: q4, value: 'Weekends' },
        { id: 'moreThanFiveYears', label: q5, value: 'Long' }
    ];

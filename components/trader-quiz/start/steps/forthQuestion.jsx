...
function ForthQuestion({ setCurrentStep, setAnswers, translations }) {
    ...
    const options = [
        { id: 'oneToThreeMonths', label: q1, value: 'Low' },
        { id: 'threeToTwelveMonths', label: q2, value: 'Low' },
        { id: 'oneToThreeYears', label: q3, value: 'Low' },
        { id: 'threeToFiveYears', label: q4, value: 'High' },
        { id: 'moreThanFiveYears', label: q5, value: 'High' }
    ];

...
function FifthQuestion({ setCurrentStep, setAnswers, translations }) {
    ...
    const options = [
        { id: 'oneToThreeMonths', label:q1, value: 'Passive' },
        { id: 'threeToTwelveMonths', label:q2, value: 'Passive' },
        { id: 'oneToThreeYears', label:q3, value: 'Passive' },
        { id: 'threeToFiveYears', label:q4, value: 'Aggressive' },
        { id: 'moreThanFiveYears', label: q5, value: 'Aggressive' }
    ];
            ...
            <div className='flex flex-col items-start my-5 mb:my-10'>
                {options.map((option) => (
                    <motion.div key={option.id} className='flex flex-row mt-4' variants={itemVariants}>
                        ...
                        />
                        <label htmlFor={option.id} className='text-textPrimary text-base font-light mb:text-xl'>
                            {option.label}
                        </label>
                    </motion.div>
                ))}

...
function FirstQuestion({ setCurrentStep, setAnswers, translations }) {
    ...
    const options = [
        { id: 'oneToThreeMonths', label: q1, value: 'New' },
        { id: 'threeToTwelveMonths', label: q2, value: 'New' },
        { id: 'oneToThreeYears', label: q3, value: 'Experienced' },
        { id: 'threeToFiveYears', label: q4, value: 'Experienced' },
        { id: 'moreThanFiveYears', label: q5, value: 'Experienced' }
    ];

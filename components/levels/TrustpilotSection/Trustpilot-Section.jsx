        ...
        <div className='px-8 mb:px-32 mb:pt-16 pb-16 mb:pb-0 -mt-10 mb:-mt-20 flex flex-col items-center bg-[#0B111D]' >
            ...
            >
                <div className='flex flex-col items-center' >
                    <div className='flex flex-col items-center '>
                        <h3 className='text-textPrimary font-light text-3xl max-w-[350px] mb:max-w-full mb:text-4xl text-center '>{translations.community_title }</h3>
                        ...
                        {/* <section className='flex flex-row mt-10'>
                            ...
                            <div className='flex flex-col ml-3'>
                                <div className='flex flex-row'>
                                    ...
                                    <p className='text-textPrimary ml-1' >Trustpilot</p>
                                </div>
                                <div className='flex flex-col bg-white/10 px-2 mt-2 rounded-md py-1'>
                                <p className="text-textPrimary text-sm">4.2/5 <span className="text-gray-500 ml-1">4,062 {translations.community_review}</span></p>
                                </div>
                            </div>
                        </section> */}
                    </div>
